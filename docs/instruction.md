...
1 指示: 中央値 2.8ms / p95 32.1ms / 最大 542ms（58.8 指示/秒）
タスク別中央値: list 0.8ms / write 0.9ms / transform 1.0ms / extract 1.5ms
              answer 5.1ms / summarize 14.3ms / code 27.4ms（実行込み）
誤検出 0/20（読み取り 中央値 0.08ms） / 禁止表現 0
```
